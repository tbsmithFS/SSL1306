...
class DBConnector():
    ...
    def get_connection(self):
        self.db = mysql.connector.connect(host="127.0.0.1", port=8889, user="root", passwd="root", db="fakeUsers")

    def get_random_user(self):
        self.get_connection()

        sql = "select firstname, lastname, city, state, zip, phone from address order by rand() limit 1"
